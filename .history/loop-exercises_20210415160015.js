...
for (b = 1; b <= 5; b++) {
    switch (b) {
        case 1: console.log("There is " + b + " bottle of beer on the wall");
        break;
        case 2: console.log("There are " + b + " bottles of beer on the wall");
        break;
        case 3: console.log("There are " + b + " bottles of beer on the wall");
        break;
        case 4: console.log("There are " + b + " bottles of beer on the wall");
        break;
        case 5: console.log("There are " + b + " bottles of beer on the wall");
    }
}
